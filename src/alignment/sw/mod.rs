...
//! ### CIGAR Outputs
//!
//! The [`AlignmentStates`] generated by all Smith-Waterman alignment functions
//! in *Zoe* will use `M`, `I`, `D`, and `S` as the only operations. Hard
//! clipping (`H`) is not used. To convert to using `=` and `X` instead of `M`,
//! use [`to_verbose_sequence_matching`] on the output [`Alignment`].
//!
//! ### Examples
//!
...
//! [`to_verbose_sequence_matching`]:
//!     crate::alignment::Alignment::to_verbose_sequence_matching
