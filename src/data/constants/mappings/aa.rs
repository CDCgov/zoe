...
pub const AA_PROFILE_MAP: ByteIndexMap<21> = ByteIndexMap::new_ignoring_case(*AA_IUPAC_UC_X, b'X');

/// Conversion from unambiguous IUPAC amino acids to indices. Converting any
/// other symbol will result in Alanine.
pub const AA_UNAMBIG_PROFILE_MAP: ByteIndexMap<20> = ByteIndexMap::new_ignoring_case(*AA_IUPAC_UC, b'A');
